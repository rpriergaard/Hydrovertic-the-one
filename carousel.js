...
let curSlide = 0;
// laver en maximum number of slides, og så finder functionen og eventlisteneren nedenunder ud af hvor mange slides der skal være efter skærmens størrelse
let maxSlide;
// get window size
